        ...
        <div style={{ background: 'white', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
          {loading ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              visibility: i.visibility || 'public', viewing_method: i.viewing_method || '', staff_name: i.staff_name || '', staff_phone: i.staff_phone || '' }); setUploadPreviews(Array.isArray(i.images) ? i.images : []); if (i.floor_plan_url) setFloorPlanPreview(i.floor_plan_url); setShowForm(true); }}
