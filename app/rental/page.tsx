        ...
        <div style={{ background: 'white', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
          {loading ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              visibility: i.visibility || 'both', viewing_method: i.viewing_method || '', staff_name: i.staff_name || '', staff_phone: i.staff_phone || '' }); setUploadPreviews(Array.isArray(i.images) ? i.images : []); setShowForm(true) }} style={{ background: '#e8f4fd', color: '#1a3a5c', border: '1px solid #b3d4f0', padding: '6px 12px', borderRadius: 6, cursor: 'pointer', fontSize: 12, fontWeight: 600 }}>
                      ✏️ 編集
                    </button>
